var getGame = function () {
  ...
  // Example usage:
  console.log(game.handleInput("go south")); // Move to the library
  console.log(game.handleInput("get")); // Get item in the library
  console.log(game.handleInput("go north")); // Move back to the kitchen
  console.log(game.handleInput("xyz")); // Invalid command
